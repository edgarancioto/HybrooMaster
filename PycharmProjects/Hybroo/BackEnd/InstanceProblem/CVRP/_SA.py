...
class SA(object):
    ...
    def solve(self, instance):
        ...
        return self.best_solution.nodes, self.best_solution.routes_vector, self.best_solution.fitness, fitness_list
...
class Solution(object):
    ...
    def __init__(self, instance, nodes):
        ...
        self.routes_vector = instance.compute_vrp_routes(self.nodes)
        self.fitness = instance.compute_vrp_distance(self.routes_vector, self.nodes)
